...
class LifecycleSubscriber implements EventSubscriberInterface
{
    ...
    {
        return array(
            'plugin.install.newscoop_externallogin_plugin_bundle' => array('install', 1),
            'plugin.update.newscoop_externallogin_plugin_bundle' => array('update', 1),
            'plugin.remove.newscoop_externallogin_plugin_bundle' => array('remove', 1),
        );
    }
